...
// Styles
import { Container, Wrapper, Header, Main, BackgroundClose, ButtonClose, Title, CloseIcon } from './style'

const Modal = props => {
  // Props
  const { title, callbackActive, component, options = {}, ...restOfProps } = props
